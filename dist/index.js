...
var PHDLogo = ({ className }) => /* @__PURE__ */ jsx(
  "svg",
  {
    className,
...
var DemoLayer = ({ config }) => {
  ...
  const overlay = mounted ? /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: `phd-demo-content ${showSplash ? "is-splashing" : ""}`, children: [
            /* @__PURE__ */ jsxs("div", { className: "phd-demo-brand", children: [
              /* @__PURE__ */ jsx(PHDLogo, { className: "phd-logo phd-logo-brand" }),
              /* @__PURE__ */ jsx("div", { className: "phd-demo-brand-text", children: "P. HEINIGER DESIGN" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "phd-demo-header", children: [
              /* @__PURE__ */ jsx("h2", { className: "phd-demo-title", children: t("title") }),
              /* @__PURE__ */ jsx("div", { className: "phd-demo-locale-toggle", "aria-label": "Locale", children: config.locales.map((loc) => /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
            ...
            step === "main" && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("p", { className: "phd-demo-body", children: t("body") }),
              /* @__PURE__ */ jsxs("div", { className: "phd-demo-actions", children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    type: "button",
            ...
            step === "intake" && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("p", { className: "phd-demo-body", children: t("intakeIntro") }),
              /* @__PURE__ */ jsxs("div", { className: "phd-demo-section", children: [
                /* @__PURE__ */ jsxs("div", { className: "phd-demo-field", children: [
                  /* @__PURE__ */ jsx("label", { htmlFor: "phd-demo-link", children: t("demoLinkLabel") }),
                  /* @__PURE__ */ jsxs("div", { id: "phd-demo-link", className: "phd-demo-demo-row", children: [
                    /* @__PURE__ */ jsx("span", { className: "phd-demo-demo-url", children: demoUrl || "-" }),
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                        type: "button",
                ...
                /* @__PURE__ */ jsxs("div", { className: "phd-demo-field", children: [
                  /* @__PURE__ */ jsx("label", { htmlFor: "phd-current-website", children: t("currentWebsiteLabel") }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                ...
                /* @__PURE__ */ jsxs("div", { className: "phd-demo-field", children: [
                  /* @__PURE__ */ jsx("label", { htmlFor: "phd-q1", children: t("q1") }),
                  /* @__PURE__ */ jsx(
                    "textarea",
                    {
                      id: "phd-q1",
                ...
                /* @__PURE__ */ jsxs("div", { className: "phd-demo-field", children: [
                  /* @__PURE__ */ jsx("label", { htmlFor: "phd-q2", children: t("q2") }),
                  /* @__PURE__ */ jsx(
                    "textarea",
                    {
                      id: "phd-q2",
                ...
                /* @__PURE__ */ jsxs("div", { className: "phd-demo-field", children: [
                  /* @__PURE__ */ jsx("label", { htmlFor: "phd-q3", children: t("q3") }),
                  /* @__PURE__ */ jsx(
                    "textarea",
                    {
                      id: "phd-q3",
              ...
              /* @__PURE__ */ jsxs("div", { className: "phd-demo-footer-actions", children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    type: "button",
              ...
              showMailHelper && /* @__PURE__ */ jsx("div", { className: "phd-demo-helper", children: t("helper") })
            ] }),
            step === "notInterested" && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs("div", { className: "phd-demo-section", children: [
                /* @__PURE__ */ jsxs("div", { className: "phd-demo-field", children: [
                  /* @__PURE__ */ jsx("label", { htmlFor: "phd-reason", children: t("reasonLabel") }),
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                      id: "phd-reason",
                      ...
                      children: [
                        /* @__PURE__ */ jsx("option", { value: "", children: t("reasonPlaceholder") }),
                        config.reasons.map((reason) => /* @__PURE__ */ jsx("option", { value: reason.value, children: reason.labels[locale] }, reason.value))
                      ]
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "phd-demo-field", children: [
                  /* @__PURE__ */ jsx("label", { htmlFor: "phd-context", children: t("contextLabel") }),
                  /* @__PURE__ */ jsx(
                    "textarea",
                    {
                      id: "phd-context",
  ...
  const handle = /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "phd-handle", children: /* @__PURE__ */ jsx(PHDLogo, { className: "phd-logo phd-handle__logo" }) }),
        /* @__PURE__ */ jsx("div", { className: "phd-handle__label", children: "P. HEINIGER DESIGN" })
      ]
    }
  );
  const portalContent = /* @__PURE__ */ jsxs("div", { className: "phd-demo-portal phd-demo-layer", style: layerStyle, children: [
    /* @__PURE__ */ jsx("div", { className: "phd-leftLine", "aria-hidden": "true" }),
    handle,
    overlay
  ] });
