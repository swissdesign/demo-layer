      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `phd-demo-content ${showSplash ? "is-splashing" : ""}`, children: [
            ...
            step === "thanks" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { textAlign: "center", padding: "16px 0" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "phd-demo-body", style: { marginBottom: "20px" }, children: t("thanks") }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "button",
                {
                  type: "button",
